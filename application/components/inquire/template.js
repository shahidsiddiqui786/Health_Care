...
const answersSingle = () => {
  return html`
    <div>
      <button type="button" data-value="true" class="next-question btn btn-success">
          <i class="fa fa-thumbs-up" aria-hidden="true"></i>
      </button>
      <button type="button" data-value="false" class="next-question btn btn-danger">
          <i class="fa fa-thumbs-down" aria-hidden="true"></i>
      </button>
      <button type="button" data-value="unknown" class="next-question btn btn-info">Skip</button>
    </div>
  `;
};
